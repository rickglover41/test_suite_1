...
def load_health_systems():
    ...
    # Sort alphabetically by Health_System_Name
...
def load_hospitals():
    ...
    # Sort alphabetically by Hospital_Name
...
# -------------------------
# Load pickled function
# -------------------------
@st.cache_resource
def load_model_function():
    with open("flo_finance.pkl", "rb") as f:
        return pickle.load(f)

flo_finance = load_model_function()
...
mode = st.radio("Choose a Health System or an Individual Hospital", ["Health System", "Individual Hospital"])

# -------------------------
# Health System Mode
# -------------------------
if mode == "Health System":
    # Sorted, searchable dropdown
